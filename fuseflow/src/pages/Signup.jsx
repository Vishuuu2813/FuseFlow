...
import { User, Mail, Lock, Building, UserPlus, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md bg-white border border-slate-200 shadow-2xl rounded-3xl p-8 flex flex-col gap-6 relative z-10">
        ...
        <div className="text-center">
          <div className="inline-flex p-3 rounded-2xl bg-emerald-55 text-emerald-600 mb-4 border border-emerald-100">
            <UserPlus size={24} />
          </div>
          <h1 className="text-2xl font-extrabold tracking-tight text-slate-800">Create Workspace</h1>
          <p className="text-slate-500 text-xs mt-1">Register your company profile and initialize a WhatsApp automation client.</p>
        </div>

        {error && (
          <div className="p-3.5 rounded-xl border border-red-200 bg-red-50 text-red-655 text-xs font-bold text-center">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">Company / Workspace Name</label>
          ...
          <div>
            <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">Your Full Name</label>
            <div className="relative">
